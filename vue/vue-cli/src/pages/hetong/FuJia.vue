<template>
  <div style="background: #fff;height: 100vh;overflow-y: scroll">
    <div class="ht">
      <p class="title">
        <strong>附件5：附加条款（合同编号{{allInfo.HeTongCode}}）</strong>
      ...
      <p class="first-space">乙方：<span class="qm-line time">{{allInfo.LvXingShe_Name}}</span></p>
      <p class="second-space">
      <p v-html="allInfo.FuJiaTiaoKuanBody"></p>
      <p class="first-space"> 甲方（代表签字）：<img class="lvyouzhe" style="left: 60px;" :src="allInfo.KeHu_QianMing">{{allInfo.KeHu_QianYueDate}}
      </p>
      <p class="first-space">乙方经办人（签字）：<img style="left:120px;" class="lvxingshe" :src="allInfo.LvXingShe_GongZhang"><img class="lvyouzhe" style="left: 60px;" :src="allInfo.LvXingShe_QianZi">{{allInfo.LvXingShe_QianYueDate}}
      </p>
