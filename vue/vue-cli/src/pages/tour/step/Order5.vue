<template>
  <div>
    <div class="order-info">
      ...
      <div class="panel">
        ...
        <div class="panel-content">
          ...
          <div class="panel-group">
            <label>结算信息：</label>
            <span>
              应付 {{yuDingInfo.YingFu}}，已付 {{yuDingInfo.SubmitPrice}} ，未付<strong class="price">¥{{yuDingInfo.WatPrice}}</strong>
            </span>
          </div>
          <div class="panel-group">
            <label>结算类型：</label>
            <span>
              <el-radio v-model="form.PayType" label="1">付款</el-radio>
              <el-radio v-model="form.PayType" label="-1">退已收款</el-radio>
            </span>
          </div>
          <div class="panel-group">
            <label>结算方式：</label>
          ...
          <div class="panel-group" v-else>
            <label>账户：</label>
            <el-autocomplete class="inline-input" v-model="form.name" :fetch-suggestions="querySearch" placeholder="请选择账户" @select="handleSelect"></el-autocomplete>
          </div>
          <div class="panel-group">
            <label>备注说明：</label>
      ...
      <div class="panel">
        <div class="panel-title"><i class="ziyuan"></i>向总社付款记录（已提交{{recordData.SubmitPrice}}，已确认{{recordData.SubmitPrice}}，未确认{{recordData.WatPrice}}）</div>
        <div class="panel-content">
          <el-table :data="recordData.List" style="width: 100%" border v-if="recordData.List">
            <el-table-column label="付款方式" prop="AccountTypeDesc" width="140" align="center"></el-table-column>
            ...
            <el-table-column label="状态" prop="FinanceStatusDesc" width="140" align="center"></el-table-column>
