  ...
  <div>
    <div class="order-info">
      ...
      <div class="panel panel-btn">
        <el-button @click="submitOrder(1)">上一步</el-button>
        <el-button @click="submitOrder(3)">下一步</el-button>
      </div>
    </div>
    <!--<div class="content">
      <div class="con-left">
        <ul>
          ...
          <li class="lf-con-item">
            ...
            <el-button type="warning" @click="submitOrder(1)">上一步</el-button>
            <el-button type="warning" @click="dialogOpen">立即投保</el-button>
            <el-button type="warning" @click="submitOrder(3)">下一步</el-button>
          </li>
          <li class="lf-con-item">
            <section class="item-header">
...
export default {
  ...
  methods: {
    ...
    submitOrder (type) {
      if (type === 1) {
        this.$router.push({name: 'tourOrder2', query: {...this.$route.query, current: type}})
      } else {
