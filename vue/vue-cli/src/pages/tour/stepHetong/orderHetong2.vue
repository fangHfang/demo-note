<template>
  <div>
    <div class="content">
      <!--        <div :class="['con-right-item', {'isFixed': isFixed === true}]">-->
      <!--          <div class="con-right">-->
      <!--            <section class="con1">应付信息</section>-->
      <!--            <section class="con2">-->
      <!--              <span>2周岁以下</span>-->
      <!--              <span>￥500 x 1</span>-->
      <!--            </section>-->
        ...
        <ul>
          <li class="lf-con-item">
            ...
            <section class="base-allInfo">
              <!--                <p><span class="base-all-item">订单编号:</span><span class="base-all-item">DLY1903071203066952538</span></p>-->
          ...
          <li class="lf-con-item">
            ...
            <section>
              <el-form ref="form" :rules="rules" :model="orderSubmit" label-width="90px">
                ...
                <!--                  <el-form-item label="备注说明:" style="margin-bottom: auto">-->
...
export default {
  ...
  methods: {
    ...
    next () {
      this.$router.push({name: 'tourOrderHetong3', query: {current: 2}})
    },
    // 提交订单 -- 下单
    submit (type) {
