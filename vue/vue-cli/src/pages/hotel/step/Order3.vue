  ...
  <div>
    <div class="order-info">
      ...
      <div class="panel panel-btn">
        <el-button @click="submitOrder(3)">上一步</el-button>
      ...
      <ul>
        <li class="lf-con-item">
          ...
          <section class="base-allInfo">
            <p><span class="base-all-item">订单编号:</span><span class="base-all-item">DD123123123</span></p>
            <p><span class="base-all-item">酒店名称:</span><span class="base-all-item">酒店名称</span></p>
            <p><span class="base-all-item">房间类型:</span><span class="base-all-item">单人间</span></p>
            <p><span class="base-all-item">入住日期:</span><span class="base-all-item">2018-05-15</span></p>
            <p><span class="base-all-item">预定客户:</span><span class="base-all-item">姓名，手机号码</span></p>
          </section>
        </li>
        <li class="lf-con-item">
          <section class="item-header">
          ...
          <section class="base-allInfo base-money">
            <p v-if="yuDingInfo.JieSuanCustomer&&yuDingInfo.JieSuanCustomer.Desc">
              ...
              <span class="base-all-item">王超 13303510000 总办(当前门店)</span>
            </p>
            <p>
              <span class="base-all-item">结算信息:</span>
              <span class="base-all-item">应付 100  已付 100, 未付 <i style="color: red">100</i></span>
            </p>
            <p>
              <span class="base-all-item">结算金额:</span>
              <span class="base-all-item"><el-input v-model="form.Price" placeholder="结算金额" style="width: 100px;"></el-input> 元</span>
            </p>
            <p>
              <span class="base-all-item">结算方式:</span>
              <span class="base-all-item">
                <el-radio v-model="form.AccountType" label="1">结算方式</el-radio>
                <el-radio v-model="form.AccountType" label="2">结算方式</el-radio>
                <el-radio v-model="form.AccountType" label="3">结算方式</el-radio>
                <el-radio v-model="form.AccountType" label="4">结算方式</el-radio>
                &lt;!&ndash;<el-radio v-model="form.AccountType" :label="item.AccountType" v-for="(item, index) in payWay" :key="index">{{item.AccountTypeDesc}}</el-radio>&ndash;&gt;
              </span>
            </p>
